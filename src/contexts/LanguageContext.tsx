...
const translations = {
  pt: {
    ...
    conversation: {
      ...
      blockedMessages: {
        ...
        mustAttachReferral: "Para realizar o pré-agendamento é obrigatório anexar o pedido médico. Assim que tiver o pedido em mãos, volte e tente novamente.",
        ...
        finalNoDoc: "Para finalizar o pré-agendamento é obrigatório anexar o pedido médico. Volte e tente novamente.",
  ...
  en: {
    ...
    uploadArea: {
      ...
      noReferral: "A medical referral is required to complete pre-booking.",
      noReferralButton: "No referral — WhatsApp",
      fileLabel: "File",
    },
    businessHours: {
  ...
  es: {
    ...
    uploadArea: {
      ...
      noReferral: "Sin la solicitud médica no es posible completar la pre-reserva.",
      noReferralButton: "No tengo solicitud — WhatsApp",
      fileLabel: "Archivo",
    },
    businessHours: {

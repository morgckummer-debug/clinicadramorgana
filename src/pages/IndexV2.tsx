...
const About = () => (
  <section id="sobre" className="py-12 md:py-16 bg-background relative overflow-hidden">
    <div className="container max-w-3xl">
      ...
      <p className="mt-10 text-foreground/85 leading-[1.8] text-lg font-light">
      ...
      <p className="mt-6 text-foreground/70 leading-[1.8] text-base font-light">
      ...
      <div className="mt-10 pt-8 border-t border-champagne/20 flex flex-col sm:flex-row gap-6 sm:gap-12">
        <div>
          <div className="text-[10px] tracking-[0.35em] uppercase text-champagne font-medium mb-1">Formação</div>
          <p className="text-foreground/75 text-sm font-light leading-relaxed">
            Medicina pela FCMMG · <span className="text-wine-deep">2006</span>
          </p>
        </div>
        <div>
          <div className="text-[10px] tracking-[0.35em] uppercase text-champagne font-medium mb-1">Especialidade</div>
          <p className="text-foreground/75 text-sm font-light leading-relaxed">
            Ultrassom Geral e Obstétrico
          </p>
        </div>
        <div>
          <div className="text-[10px] tracking-[0.35em] uppercase text-champagne font-medium mb-1">Pós-graduação</div>
          <p className="text-foreground/75 text-sm font-light leading-relaxed">
            Medicina Fetal
          </p>
        </div>
